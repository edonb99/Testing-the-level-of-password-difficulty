      ...
      <div className="px-4 py-2 mb-2 bg-gray-100 rounded-md shadow-xl">
        <div className="flex flex-row justify-between px-0 py-2 mb-4 bg-white md:px-2">
          ...
          <button
            ...
            className="text-red-500 bg-white border-none cursor-pointer top-1 right-1 "
          >
            <svg
        ...
        <div className="flex flex-row justify-between mb-2 md:mb-4">
          <label htmlFor="password-strength" className="text-gray-800">
            Karaktere të fjalëkalimit
          </label>
          <input
        ...
        <button
          ...
          className="block w-full p-2 mx-auto my-0 text-base text-blue-100 transition-all duration-500 bg-blue-600 border-none rounded md:w-1/4 translate scale hover:scale-110 hover:bg-blue-900 hover:text-blue-200 curser-pointer"
        >
