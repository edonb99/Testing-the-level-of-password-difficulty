    ...
    return(
        <div className="flex flex-col px-14 justify-between bg-red-500">
            ...
            <div className="w-44 h-44 mt-5">
                <a title="Universiteti i Prishtinës" href="https://fiek.uni-pr.edu/" target="_blank" class="block w-44 h-44 transition-all rounded-full shadow hover:shadow-lg transform-all hover:scale-110 duration-300">
            ...
            <div className="transition-all hover:shadow-lg transform-all hover:scale-110 duration-300 text-red-100 font-medium text-left mb-5">
